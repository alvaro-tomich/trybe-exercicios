...
else if ( salario >= 1556.95 && salario <= 1903.98 ){

    salario = salario - ( salario * 0.09 );
}
else if ( salario >= 1903.99 && salario <= 2594.92 ){

    salario = salario - ( salario * 0.09)
    salario = salario - ( ( salario * 0.075) - 142.80 );
}
else if ( salario >= 2594.93 && salario <= 2826.65 ){
...
else if ( salario > 4664.68 && salario <= 5189.82 ){
